package be.kdg.prog6.ticketingTest.architecture;
...
public class ArchitectureTest {
    private static final String DOMAIN_LAYER = "be.kdg.prog6.ticketing.domain..";

    private static final String ADAPTER_LAYER = "be.kdg.prog6.ticketing.adapters..";
    private static final String CORE_LAYER = "be.kdg.prog6.ticketing.core..";
    private static final String PORT_LAYER = "be.kdg.prog6.ticketing.ports..";
    ...
    void givenApplicationClasses_thenNoLayerViolationsShouldExist() {
        ...
        JavaClasses jc = new ClassFileImporter().importPackages("be.kdg.prog6.ticketing");
