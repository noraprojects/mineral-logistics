package be.kdg.prog6.admissionTest.architecture;
...
public class ArchitectureTest {
    private static final String DOMAIN_LAYER = "be.kdg.prog6.Admission.domain..";

    private static final String ADAPTER_LAYER = "be.kdg.prog6.Admission.adapters..";
    private static final String CORE_LAYER = "be.kdg.prog6.Admission.core..";
    private static final String PORT_LAYER = "be.kdg.prog6.Admission.ports..";
    ...
    void givenApplicationClasses_thenNoLayerViolationsShouldExist() {
        ...
        JavaClasses jc = new ClassFileImporter().importPackages("be.kdg.prog6.Admission");
