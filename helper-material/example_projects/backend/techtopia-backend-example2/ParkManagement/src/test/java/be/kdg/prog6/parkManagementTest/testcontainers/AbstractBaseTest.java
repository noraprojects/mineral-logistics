...
import be.kdg.prog6.parkManagement.ParkManagementApplication;
...
@SpringBootTest(classes = ParkManagementApplication.class)
...
public abstract class AbstractBaseTest {
    ...
    @BeforeEach
    void resetDatabase() {
        //here you can delete all for instance, or insert seeded data for your tests.
    }
