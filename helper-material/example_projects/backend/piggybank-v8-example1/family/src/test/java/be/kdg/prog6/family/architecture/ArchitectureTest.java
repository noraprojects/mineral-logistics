...
public class ArchitectureTest {
    private static final String DOMAIN_LAYER = "be.kdg.prog6.family.domain..";

    private static final String ADAPTER_LAYER = "be.kdg.prog6.family.adapters..";
    private static final String CORE_LAYER = "be.kdg.prog6.family.core..";
    private static final String PORT_LAYER = "be.kdg.prog6.family.ports..";
    ...
    void givenApplicationClasses_thenNoLayerViolationsShouldExist() {
        ...
        JavaClasses jc = new ClassFileImporter().importPackages("be.kdg.prog6.family");
